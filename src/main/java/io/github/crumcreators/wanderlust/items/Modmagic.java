...
public class Modmagic {
    public static final Item MAGICAL_TWIG = new Item(new FabricItemSettings().group(ItemGroup.BREWING));
    public static final Item MAGIC_WAND = new Item(new FabricItemSettings().group(ItemGroup.BREWING));
    public static final Item STAFF = new Item(new FabricItemSettings().group(ItemGroup.BREWING));
    public static final Item PRISM = new Item(new FabricItemSettings().group(ItemGroup.BREWING));

    public static void ModMagic() {
        initializeMagic();
    }
    //Register Magic
